...
document.querySelectorAll(".lista-noticias").forEach(element => {
    ...
    if (moveToAttr != "intro") {
        document.querySelector(".wrap").style.transform = `translateY(-${tamanhoContent}px)`
    }else { document.querySelector(".wrap").style.transform = `translateY(${0}px)`
}
...
;
let menu = document.querySelector('.lista-noticias');
